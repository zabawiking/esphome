...
#define OPENTHERM_MESSAGE_TIMEOUT_SENSOR_ENTITY(key, msg_data) this->key->publish_state(NAN);
#define OPENTHERM_MESSAGE_TIMEOUT_BINARY_SENSOR_ENTITY(key, msg_data) this->key->publish_state(false);
